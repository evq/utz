...
static const urule_packed_t zone_rules[105] = {
...
{  0, 255, 7,  0,  1,  2, 0, 1,  3, 1}, // 	C-Eur	1981	max	-	Mar	lastSun	 2:00s	1:00	S
{  0, 255, 7,  0,  1,  2, 0, 0, 10, 0}, // 	C-Eur	1996	max	-	Oct	lastSun	 2:00s	0	-
...
{ 14,  21, 7,  0,  1,  2, 0, 1,  3, 1}, // 	Morocco	2014	2021	-	Mar	lastSun	 2:00	1:00	S
{ 26, 255, 7,  0,  1,  2, 0, 1,  3, 1}, // 	Morocco	2026	max	-	Mar	lastSun	 2:00	1:00	S
{ 20,  20, 0, 19,  1,  2, 0, 0,  4, 0}, // 	Morocco	2020	only	-	Apr	19	 3:00	0	-
{ 21,  21, 0, 11,  1,  2, 0, 0,  4, 0}, // 	Morocco	2021	only	-	Apr	11	 3:00	0	-
...
{ 17,  17, 0, 21,  1,  2, 0, 0,  5, 0}, // 	Morocco	2017	only	-	May	21	 3:00	0	-
{ 18,  18, 0, 13,  1,  2, 0, 0,  5, 0}, // 	Morocco	2018	only	-	May	13	 3:00	0	-
{ 19,  19, 0,  5,  1,  2, 0, 0,  5, 0}, // 	Morocco	2019	only	-	May	 5	 3:00	0	-
{ 20,  20, 0, 24,  1,  2, 0, 1,  5, 1}, // 	Morocco	2020	only	-	May	24	 2:00	1:00	S
{ 21,  21, 0, 16,  1,  2, 0, 1,  5, 1}, // 	Morocco	2021	only	-	May	16	 2:00	1:00	S
{ 22,  22, 0,  8,  1,  2, 0, 1,  5, 1}, // 	Morocco	2022	only	-	May	 8	 2:00	1:00	S
{ 18,  18, 0, 17,  1,  2, 0, 1,  6, 1}, // 	Morocco	2018	only	-	Jun	17	 2:00	1:00	S
{ 19,  19, 0,  9,  1,  2, 0, 1,  6, 1}, // 	Morocco	2019	only	-	Jun	 9	 2:00	1:00	S
{ 17,  17, 0,  2,  1,  2, 0, 1,  7, 1}, // 	Morocco	2017	only	-	Jul	 2	 2:00	1:00	S
...
{ 16, 255, 6,  0,  1,  1, 0, 1,  3, 1}, //  Palestine	2016	max	-	Mar	lastSat	1:00	1:00	S
{ 16, 255, 6,  0,  1,  0, 0, 0, 10, 0}, //  Palestine	2016	max	-	Oct	lastSat	1:00	0	-
{ 13, 255, 6, 21,  1, 23, 0, 0,  3, 0}, // 	Para	2013	max	-	Mar	Sun>=22	0:00	0	-
{ 10, 255, 7,  1,  1,  0, 0, 1, 10, 1}, // 	Para	2010	max	-	Oct	Sun>=1	0:00	1:00	S
{ 12, 255, 5,  0,  1,  0, 0, 1,  3, 1}, // 	Syria	2012	max	-	Mar	lastFri	0:00	1:00	S
{  9, 255, 5,  0,  1,  0, 0, 0, 10, 0}, // 	Syria	2009	max	-	Oct	lastFri	0:00	0	-
{  7, 255, 7,  8,  1,  2, 0, 2,  3, 1}, // 	Thule	2007	max	-	Mar	Sun>=8	2:00	1:00	D
{  7, 255, 7,  1,  1,  1, 0, 1, 11, 0}, // 	Thule	2007	max	-	Nov	Sun>=1	2:00	0	S
...
{ 12, 255, 7,  1,  1,  3, 0, 1,  4, 0}, // 	WS	2012	max	-	Apr	Sun>=1	4:00	0	S
{ 12, 255, 7,  0,  1,  3, 0, 2,  9, 1}, // 	WS	2012	max	-	Sep	lastSun	3:00	1	D
{ 13, 255, 5, 23,  1,  2, 0, 2,  3, 1}, // 	Zion	2013	max	-	Mar	Fri>=23	2:00	1:00	D
{ 13, 255, 7,  0,  1,  1, 0, 1, 10, 0}, // 	Zion	2013	max	-	Oct	lastSun	2:00	0	S
};

static const uzone_packed_t zone_defns[165] = {
...
static const unsigned char zone_names[1267] = {
                    ...
                    'B','e','l','o',' ','H','o','r','i','z','o','n','t','e','\0',  51, // Belo Horizonte
                            ...
                            'B','u','e','n','o','s',' ','A','i','r','e','s','\0',  16, // Buenos Aires
                                                        'C','a','i','r','o','\0',   3, // Cairo
                                            'C','a','l','c','u','t','t','a','\0',  84, // Calcutta
                                    'C','a','p','e',' ','V','e','r','d','e','\0', 104, // Cape Verde
                                    ...
                                    'C','o','s','t','a',' ','R','i','c','a','\0',  22, // Costa Rica
            'D','a','l','l','a','s','F','o','r','t',' ','W','o','r','t','h','\0',  30, // DallasFort Worth
                        ...
                        'I','n','l','a','n','d',' ','E','m','p','i','r','e','\0',  44, // Inland Empire
                            ...
                            'K','u','a','l','a',' ','L','u','m','p','u','r','\0',  85, // Kuala Lumpur
                                                    'K','u','w','a','i','t','\0',  60, // Kuwait
                                                    'L','a','h','o','r','e','\0',  82, // Lahore
                                                    'L','o','n','d','o','n','\0', 120, // London
                                'L','o','s',' ','A','n','g','e','l','e','s','\0',  44, // Los Angeles
                    ...
                    'R','i','o',' ','d','e',' ','J','a','n','e','i','r','o','\0',  51, // Rio de Janeiro
                        'S','a','n',' ','F','r','a','n','c','i','s','c','o','\0',  44, // San Francisco
                                            'S','a','n','t','i','a','g','o','\0',  50, // Santiago
                                        'S','a','o',' ','P','a','u','l','o','\0',  51, // Sao Paulo
                        ...
                        'S','o','u','t','h',' ','G','e','o','r','g','i','a','\0', 105, // South Georgia
                                            'S','t',' ','J','o','h','n','s','\0',  53, // St Johns
            ...
            'W','a','s','h','i','n','g','t','o','n',',',' ','D','.','C','.','\0',  34, // Washington, D.C.
